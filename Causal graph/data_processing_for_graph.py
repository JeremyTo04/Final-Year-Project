...
def encode_action_units(csv_file_path, output_file_path):
    ...
    relevant_columns = ['AU', 'ethnicity', 'glasses', "fringe", "gender", 'Emotion'] # 4dme
    ...
    df['AU'] = df['AU'].map(combination_mapping)
...
input_csv = r"C:\Users\jeret\OneDrive\Desktop\fit 3163\Actual non assignment stuff\Datasets\4DME\micro-expression.csv"
output_csv = 'encoded_microexpression_data_4dme.csv'  # Replace with your desired output CSV file path
